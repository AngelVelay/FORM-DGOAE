...
import { IconButton, Divider, Drawer, List, ListItem, ListItemText, makeStyles } from "@material-ui/core"
...
const useStyles = makeStyles({
    ...
    settings:{
        marginLeft:'20px', fontsize: '14px', color:'gray'
    }
});
    ...
    const listElementSideBar = (anchor) => (
        ...
        <div style={{ width: '200px' }} role='presentation'>
            ...
            <List>
                <ListItem>
                    <ListItemText style={{ fontSize: '48px', marginLeft: '5px' }}>
                        ...
                        <span style={{ color: '#2349F5', fontWeight: '500', fontSize: '22px', fontFamily: "'Product Sans', Arial, sans-serif" }}>D</span>
                        <span style={{ color: '#2349F5', fontWeight: '500', fontSize: '22px', fontFamily: "'Product Sans', Arial, sans-serif" }}>G</span>
                        <span style={{ color: '#2349F5', fontWeight: '500', fontSize: '22px', fontFamily: "'Product Sans', Arial, sans-serif" }}>O</span>
                        <span style={{ color: '#2349F5', fontWeight: '500', fontSize: '22px', fontFamily: "'Product Sans', Arial, sans-serif" }}>A</span>
                        <span style={{ color: '#2349F5', fontWeight: '500', fontSize: '22px', marginRight: '10px', fontFamily: "'Product Sans', Arial, sans-serif" }}>E</span>
            ...
            <List style={{ marginLeft: '8px', marginRight: '8px', marginTop: '8px' }}>
                ...
                <ListItem className='list_item'>
                    <img src={sheetsimage} className={classes.logoimages} />
                    <div className={classes.listItem}>Sheets</div>
                </ListItem>
                <ListItem className='list_item'>
                    <img src={slidesimage} className={classes.logoimages} />
